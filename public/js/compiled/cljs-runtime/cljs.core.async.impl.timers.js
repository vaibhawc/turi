...
var i_32935 = (self__.level + (1));
while(true){
if((i_32935 <= (new_level + (1)))){
(update[i_32935] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_32937 = (update[i]).forward;
(x__$2.forward[i] = (links_32937[i]));
...
var i_32939 = (0);
while(true){
if((i_32939 <= self__.level)){
var links_32940 = (update[i_32939]).forward;
if((x__$1 === (((i_32939 < links_32940.length))?(links_32940[i_32939]):null))){
(links_32940[i_32939] = (x__$1.forward[i_32939]));

var G__32941 = (i_32939 + (1));
i_32939 = G__32941;
continue;
} else {
var G__32942 = (i_32939 + (1));
i_32939 = G__32942;
continue;
}
} else {
