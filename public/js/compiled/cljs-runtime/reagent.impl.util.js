...
var self__ = this;
var self__ = this;
var G__36549 = (arguments.length - (1));
switch (G__36549) {
case (0):
...
(reagent.impl.util.PartialFn.prototype.apply = (function (self__,args36548){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args36548)));
}));
...
var _STAR_always_update_STAR__orig_val__36596 = reagent.impl.util._STAR_always_update_STAR_;
var _STAR_always_update_STAR__temp_val__36597 = true;
(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__temp_val__36597);

try{return (comp["forceUpdate"])();
}finally {(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__orig_val__36596);
}} else {
