...
var G__29969 = devtools.prefs.pref(v);
v = G__29969;
continue;
} else {
return v;
...
}catch (e29838){var _e__27687__auto__ = e29838;
return false;
}})();
...
}catch (e29888){var _e__27687__auto__ = e29888;
return false;
}})();
...
}catch (e29893){var _e__27687__auto__ = e29893;
return false;
}}
}
});
...
var vec__29921 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29921,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29921,(1),null);
...
return cljs.core.some((function (p1__29927_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__29927_SHARP_);
}),template);
});
