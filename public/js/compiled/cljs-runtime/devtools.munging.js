...
var o29490 = temp__5733__auto__;
var temp__5733__auto____$1 = (o29490["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o29491 = temp__5733__auto____$1;
return (o29491["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27672__auto__ = f;
return (o__27672__auto__["toString"]).call(o__27672__auto__);
} else {
return "";
}
}catch (e29493){var _ = e29493;
return "";
}});
...
try{var o__27672__auto___29847 = t;
(o__27672__auto___29847["cljs$lang$ctorPrWriter"]).call(o__27672__auto___29847,t,writer);
}catch (e29494){var __29848 = e29494;
}
...
var char_code = (function (){var o__27672__auto__ = (new String(char$));
return (o__27672__auto__["charCodeAt"]).call(o__27672__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27672__auto__ = String;
return (o__27672__auto__["fromCharCode"]).call(o__27672__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__29497 = num_code;
switch (G__29497) {
case (1):
return (185);
...
var o__27672__auto__ = String;
return (o__27672__auto__["fromCharCode"]).call(o__27672__auto__,superscript_code);
});
/**
...
}catch (e29502){var _e__27687__auto__ = e29502;
return false;
}})())){
...
var vec__29503 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29503,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o29523 = temp__5733__auto__;
var temp__5733__auto____$1 = (o29523["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o29524 = temp__5733__auto____$1;
return (o29524["nameToPath"]);
} else {
return null;
}
} else {
...
var G__29906 = (i__4790__auto___29901 + (1));
i__4790__auto___29901 = G__29906;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__29527){
var vec__29528 = p__29527;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29528,(0),null);
...
var G__29911 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__29912 = cljs.core.butlast(remaining_tokens);
name_tokens = G__29911;
remaining_tokens = G__29912;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq29525){
var G__29526 = cljs.core.first(seq29525);
var seq29525__$1 = cljs.core.next(seq29525);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29526,seq29525__$1);
}));
...
var vec__29536 = cljs.core.split_with((function (p1__29535_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__29535_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29536,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29536,(1),null);
...
var vec__29556 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29556,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29556,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__29954 = cljs.core.rest(remaining_tokens);
var G__29955 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__29954;
name_tokens = G__29955;
continue;
} else {
...
var vec__29564 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29564,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29564,(1),null);
var vec__29567 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29567,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29567,(1),null);
var vec__29570 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29570,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29570,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29570,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29570,(3),null);
...
var vec__29588 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29588,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29588,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29588,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29588,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29588,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29588,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__29597 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29597,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29597,(1),null);
var vec__29600 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29600,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29600,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__29610 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__29610) : devtools.munging.parse_fn_info_deep.call(null,G__29610));
})()));
}
} else {
return fn_info;
...
var G__29970 = (arity + (1));
var G__29971 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__29615){
var vec__29616 = p__29615;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29616,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29616,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29619_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__29619_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29620_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__29620_SHARP_);
}),sorted_infos);
...
args__4795__auto__.push((arguments[i__4790__auto___29992]));
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__29632){
var vec__29633 = p__29632;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29633,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq29627){
var G__29628 = cljs.core.first(seq29627);
var seq29627__$1 = cljs.core.next(seq29627);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29628,seq29627__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29702__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29702__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29702__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29702__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__29703 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29703,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29703,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29703,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29703,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29703,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29703,(5),null);
...
var o__27672__auto__ = f;
return (o__27672__auto__["getBasis"]).call(o__27672__auto__);
});
/**
...
}catch (e29712){var _e__27687__auto__ = e29712;
...
var G__30050 = (obj[cljs.core.first(path)]);
var G__30051 = cljs.core.rest(path);
obj = G__30050;
path = G__30051;
continue;
} else {
...
var _STAR_ = (function (accum,p__29753){
var vec__29754 = p__29753;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29754,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29754,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__29795){
var vec__29796 = p__29795;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29796,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29796,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29796,(2),null);
...
var post_process = (function (p__29809){
var vec__29810 = p__29809;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29810,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29810,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29806_SHARP_){
return (obj[cljs.core.first(p1__29806_SHARP_)]);
}),sorted_matches);
